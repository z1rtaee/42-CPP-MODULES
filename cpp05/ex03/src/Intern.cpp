...
Intern::Intern() {
    std::cout << MAGENTA << ".✦ ݁˖ " << BOLD << "Intern Default constructor called for " << MAGENTA << " (˶ᵔ ᵕ ᵔ˶)" << RESET << std::endl;
}

Intern::Intern(const Intern &src) {
    std::cout << MAGENTA << ".✦ ݁˖ " << BOLD << "Intern Copy constructor called for " << MAGENTA << " (˶ᵔ ᵕ ᵔ˶)" << RESET << std::endl;
    (void)src;
}

Intern::~Intern() {
    std::cout << MAGENTA << ".✦ ݁˖ " << BOLD << "Intern Default Destructor called for " << MAGENTA << " (˶ᵔ ᵕ ᵔ˶)" << RESET << std::endl;
}

Intern& Intern::operator=(const Intern &obj) {
    std::cout << MAGENTA << ".✦ ݁˖ " << BOLD << "Intern Copy Assignment called for " << MAGENTA << " (˶ᵔ ᵕ ᵔ˶)" << RESET << std::endl;
    (void)obj;
    return *this;
}
